...
class ExpenseForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ( 'fiscal_year', 'audit_year', 'audit_period_start','audit_period_end', 'para_no', 'para_type', 'present_objection_status', 'finished_date', 'finished_letter_no', 'audit_Objection_Title', 'amount',
                 'amount_in_word', 'cause_of_objection', 'description_of_objetion', 'recommendation', 'action', 
                  'last_reply_no','last_reply_date',  'comments', 'have_suit', 'suit_type', 'suit_number', 'suit_description') #'FileUpload.file_description', 'FileUpload.ocument', ) #//'auditor_comment',
        ...
        labels = {
                    ...
                    'comments': _('মন্তব্য:'),
                    'have_suit': _('আপত্তিতে জড়িত অনাদায়ী টাকা আদায়ের জন্য আদালতে মামলা দায়ের করা হয়েছে কিনা?'),
                    'suit_type': _('মামলার ধরণ:'),
                    'suit_number': _('মামলার সংখ্যা:'),
                    'suit_description': _('মামলা নং সহ মামলার বিবরণ'),
                    'suit_amount': _('মামলায় জড়িত টাকার পরিমাণ')
        ...
        widgets = {
            'audit_period_start': DatePickerInput(options={
            "format": "YYYY-MM-DD",
            
            }),

            'audit_period_end': DatePickerInput(options={
            "format": "YYYY-MM-DD",
            
            }),
            'finished_date': DatePickerInput(options={
            "format": "YYYY-MM-DD",
            
            }),
            'issued_letter_date': DatePickerInput(options={
            "format": "YYYY-MM-DD",
            
            }), # specify date-frmat
            'last_reply_date': DatePickerInput(options={
            "format": "YYYY-MM-DD",
